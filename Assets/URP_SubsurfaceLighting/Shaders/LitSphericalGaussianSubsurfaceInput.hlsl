...
#ifndef UNIVERSAL_LIT_SG_SUBSURFACE_INPUT_INCLUDED
#define UNIVERSAL_LIT_SG_SUBSURFACE_INPUT_INCLUDED
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float2, _CurvatureScaleBias)
    UNITY_DOTS_INSTANCED_PROP(float3, _FalloffColor)
    UNITY_DOTS_INSTANCED_PROP(float3, _ScatterColor)
...
#define _CurvatureScaleBias     UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float2 , Metadata_CurvatureScaleBias)
#define _FalloffColor           UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float3 , Metadata_FalloffColor)
#define _ScatterColor           UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float3 , Metadata_ScatterColor)
#endif
...
#endif  // UNIVERSAL_LIT_PREINTEGRATED_INPUT_INCLUDED
