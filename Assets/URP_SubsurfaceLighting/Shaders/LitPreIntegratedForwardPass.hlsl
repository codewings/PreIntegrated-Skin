#ifndef UNIVERSAL_FORWARD_PREINTEGRATED_PASS_INCLUDED
#define UNIVERSAL_FORWARD_PREINTEGRATED_PASS_INCLUDED

#include "./LitPreIntegratedLighting.hlsl"
...
half4 UniversalFragmentPreIntegratedPBR(InputData inputData, SurfaceData surfaceData, half curvature, half3 blurredNormalWS)
{
...
half4 LitPassFragment(Varyings input) : SV_Target
{
    ...
    half4 color = UniversalFragmentPreIntegratedPBR(inputData, surfaceData, curvature, input.normalWS);
