...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    internal class LitPreIntegratedShader : BaseShaderGUI
    {
        ...
        private MaterialProperty lutTextureProperty;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            lutTextureProperty = BaseShaderGUI.FindProperty("_ScatterLUT", properties, false);
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            EditorGUILayout.Space();
            {
                ...
                materialEditor.TexturePropertySingleLine(new GUIContent("PreIntegrated LUT"), lutTextureProperty, null);
                if (EditorGUI.EndChangeCheck())
                {
                    if (lutTextureProperty.textureValue == null)
                    {
                        material.EnableKeyword("_PREINTEGRATED_WITH_CURVA_APPROX");
                    }
                    else
                    {
                        material.DisableKeyword("_PREINTEGRATED_WITH_CURVA_APPROX");
                    }
                }
                if (curvatureScaleBiasProperty != null)
                {
                    EditorGUILayout.HelpBox(lutTextureProperty.textureValue == null ? "Using curve approximation mode" : "Using LUT mode", MessageType.None, true);
